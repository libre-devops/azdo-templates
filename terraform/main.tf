module "rg" {
  source = "git::https://libredevops@dev.azure.com/libredevops/libredevops/_git/terraform-modules//terraform-azurerm-rg"
...
module "network" {
  source = "git::https://libredevops@dev.azure.com/libredevops/libredevops/_git/terraform-modules//terraform-azurerm-network"
